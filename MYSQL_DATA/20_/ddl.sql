...
CREATE TABLE IF NOT EXISTS `tastylog`.`m_address` (
  ...
  INDEX `idx_address_post_code` (`post_code` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tastylog`.`t_shop` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `idx_shop_id` (`id` ASC) ,
  INDEX `idx_post_code` (`post_code` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tastylog`.`t_review` (
  ...
  PRIMARY KEY (`id`),
  INDEX `idx_review_user_id` (`user_id` ASC) ,
  INDEX `idx_review_shop_id` (`shop_id` ASC) ,
  UNIQUE INDEX `idx_review_id` (`id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tastylog`.`t_shop_category` (
  ...
  INDEX `idx_shop_category_shop_id` (`shop_id` ASC) ,
  INDEX `idx_shop_category_category_id` (`category_id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tastylog`.`t_login_history` (
  ...
  `status` INT NOT NULL,
  INDEX `idx_login_history_user_id` (`user_id` ASC, `login` ASC) )
ENGINE = InnoDB;
